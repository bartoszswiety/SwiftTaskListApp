...
class UserRegisterViewController: UIStackViewController, UITextFieldDelegate {
    ...
    var registerButton: UIButton = {
        let btn = UIButton(style: UIButton.Style.round)
    ...
    @objc func submit() {
        ...
        API.shared.user.singup(name: loginField.text!, email: emailField.text!, password: passwordField.text!) { result, message in
